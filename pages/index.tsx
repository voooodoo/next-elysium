  ...
  return (
    <div className="app">
      <Head>
        ...
        <script src="https://cdn.snipcart.com/scripts/2.0/snipcart.js" data-api-key="NmVlNjhhMzYtNzE3Mi00YmJhLTg2ZDktM2FiNTViZjA0YmEzNjM3MDg0ODYxOTAzNzk0MDcw" id="snipcart"></script>
